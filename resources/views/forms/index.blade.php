...
@section('content')
    ...
    <div class="grid grid-cols-3 gap-4">
        ...
        {{-- PCIC ADSS Form --}}
        <div class="bg-white rounded border border-gray-300 p-5 hover:border-primary transition">
            <div class="bg-blue-100 w-12 h-12 rounded border border-blue-200 flex items-center justify-center mb-4">
            ...
            <div class="flex items-center justify-between">
                <span class="text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded border border-blue-200">ADSS Form No. 1</span>
                <a href="{{ route('forms.pcic-adss') }}"
                    class="bg-primary hover:bg-primary-dark text-white text-xs font-semibold px-3 py-1.5 rounded transition">
                    Fill Out →
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded border border-gray-300 p-5 hover:border-primary transition">
            <div class="bg-green-100 w-12 h-12 rounded border border-green-200 flex items-center justify-center mb-4">
            ...
            <div class="flex items-center justify-between">
                <span class="text-xs bg-green-100 text-green-700 px-2 py-1 rounded border border-green-200">LIV-UPI-01</span>
        ...
        <div
            class="bg-gray-50 rounded border border-dashed border-gray-300 p-5 flex flex-col items-center justify-center text-center">
