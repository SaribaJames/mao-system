            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    <div>
                        ...
                        {{-- Quick notice --}}
                        <div class="mt-2 bg-yellow-50 border border-yellow-200 rounded p-3 flex items-start gap-2">
                            <i class="fa-solid fa-triangle-exclamation text-yellow-600 text-xs mt-0.5"></i>
                            <div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" rows="2"
                        class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary">{{ old('description') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="remarks" rows="2"
                        class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary">{{ old('remarks') }}</textarea>
                </div>
            </div>
