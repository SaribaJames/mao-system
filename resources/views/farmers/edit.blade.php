...
@php
    $parcel1 = isset($farmer) ? $farmer->farmParcels->get(0) : null;
    $parcel2 = isset($farmer) ? $farmer->farmParcels->get(1) : null;
    $parcel3 = isset($farmer) ? $farmer->farmParcels->get(2) : null;
@endphp
<div class="rsbsa-page-2" style="position:relative;width:850px;height:1275px;margin:0 auto 24px auto;background:#fff;box-shadow:0 2px 12px rgba(0,0,0,.15);">
<img src="{{ asset('images/rsbsa_page-2.jpg') }}" alt="RSBSA Page 2" style="width:100%;height:1275px;display:block;pointer-events:none;user-select:none;">

{{-- HEADER --}}
<input type="text" name="no_of_parcels" value="{{ old('no_of_parcels', $parcel1 ? $farmer->farmParcels->count() : '') }}" autocomplete="off"
    class="f" style="top:2.72%;left:19.22%;width:5.09%;height:1.24%;">
<input type="text" name="rotation_p1" value="{{ old('rotation_p1') }}" autocomplete="off"
    class="f" style="top:2.55%;left:45.84%;width:14.54%;height:1.24%;font-size:9px;">
<input type="text" name="rotation_p2" value="{{ old('rotation_p2') }}" autocomplete="off"
    class="f" style="top:2.58%;left:63.21%;width:14.54%;height:1.24%;font-size:9px;">
<input type="text" name="rotation_p3" value="{{ old('rotation_p3') }}" autocomplete="off"
    class="f" style="top:2.58%;left:80.48%;width:14.54%;height:1.24%;font-size:9px;">

{{-- ══ PARCEL 1 ══ --}}
<input type="text" name="parcel_barangay[]" value="{{ old('parcel_barangay.0', $parcel1?->farm_location_barangay ?? '') }}" autocomplete="off"
    class="f" style="top:11.01%;left:16.81%;width:27.50%;height:1.00%;font-size:9px;">
<input type="text" name="parcel_municipality[]" value="{{ old('parcel_municipality.0', $parcel1?->farm_location_municipality ?? '') }}" autocomplete="off"
    class="f" style="top:12.18%;left:16.81%;width:27.50%;height:1.00%;font-size:9px;">
<input type="text" name="parcel_area[]" value="{{ old('parcel_area.0', $parcel1?->total_farm_area_ha ?? '') }}" autocomplete="off"
    class="f" style="top:13.97%;left:23.93%;width:2.26%;height:1.00%;font-size:9px;">
<input type="text" name="parcel_doc_code[]" value="{{ old('parcel_doc_code.0', $parcel1?->ownership_document_code ?? '') }}" autocomplete="off"
    class="f" style="top:16.15%;left:22.86%;width:2.80%;height:1.00%;font-size:9px;">
<input type="checkbox" class="cb" style="top:15.35%;left:30.10%;" {{ $parcel1?->within_ancestral_domain ? 'checked' : '' }}>
<input type="checkbox" class="cb" style="top:15.36%;left:37.11%;" {{ !$parcel1?->within_ancestral_domain ? 'checked' : '' }}>
<input type="checkbox" class="cb" style="top:17.51%;left:30.10%;" {{ $parcel1?->agrarian_reform_beneficiary ? 'checked' : '' }}>
<input type="checkbox" class="cb" style="top:17.50%;left:37.14%;" {{ !$parcel1?->agrarian_reform_beneficiary ? 'checked' : '' }}>
<input type="checkbox" class="cb" style="top:19.33%;left:24.32%;">
<input type="checkbox" class="cb" style="top:19.32%;left:10.37%;">
<input type="checkbox" class="cb" style="top:20.45%;left:10.36%;">
<input type="checkbox" class="cb" style="top:21.65%;left:10.37%;">
<input type="text" name="parcel_owner_name[]" value="{{ old('parcel_owner_name.0', $parcel1?->owner_name ?? '') }}" autocomplete="off"
    class="f" style="top:19.97%;left:26.26%;width:17.86%;height:1.00%;font-size:8px;">
<input type="text" class="f" style="top:21.16%;left:26.31%;width:17.77%;height:1.00%;font-size:8px;">
<input type="text" class="f" style="top:18.84%;left:29.45%;width:14.50%;height:1.00%;font-size:8px;">
<input type="text" name="parcel_crop[]" value="{{ old('parcel_crop.0', $parcel1?->crop_commodity ?? '') }}" autocomplete="off"
    class="f" style="top:10.82%;left:46.06%;width:12.21%;height:2.43%;font-size:8px;">
<input type="text" name="parcel_size[]" value="{{ old('parcel_size.0', $parcel1?->size_ha ?? '') }}" autocomplete="off"
    class="f" style="top:10.91%;left:58.30%;width:6.83%;height:2.43%;font-size:8px;">
<input type="text" name="parcel_no_head[]" value="{{ old('parcel_no_head.0', $parcel1?->no_of_head ?? '') }}" autocomplete="off"
    class="f" style="top:10.90%;left:64.94%;width:6.83%;height:2.43%;font-size:8px;">
<input type="text" name="parcel_farm_type[]" value="{{ old('parcel_farm_type.0', $parcel1?->farm_type ?? '') }}" autocomplete="off"
    class="f" style="top:10.95%;left:71.69%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" name="parcel_organic[]" value="{{ old('parcel_organic.0', $parcel1?->organic_practitioner ? 'Y' : '') }}" autocomplete="off"
    class="f" style="top:10.92%;left:79.09%;width:7.19%;height:2.43%;font-size:8px;">
<input type="text" name="parcel_remarks[]" value="{{ old('parcel_remarks.0', $parcel1?->remarks ?? '') }}" autocomplete="off"
    class="f" style="top:10.86%;left:86.29%;width:9.00%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:13.24%;left:46.11%;width:12.21%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:13.33%;left:58.38%;width:6.83%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:13.32%;left:65.12%;width:6.57%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:13.35%;left:71.75%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" class="f" style="top:13.27%;left:79.11%;width:7.19%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:13.32%;left:86.39%;width:9.00%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:15.69%;left:46.08%;width:12.21%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:15.70%;left:58.27%;width:6.83%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:15.65%;left:65.05%;width:6.57%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:15.62%;left:71.78%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" class="f" style="top:15.65%;left:79.04%;width:7.19%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:15.63%;left:86.21%;width:9.00%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:17.99%;left:46.12%;width:12.21%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:18.05%;left:58.35%;width:6.83%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:17.94%;left:65.10%;width:6.57%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:18.02%;left:71.72%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" class="f" style="top:17.97%;left:79.04%;width:7.19%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:17.95%;left:86.31%;width:9.00%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:20.38%;left:46.15%;width:12.21%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:20.39%;left:58.32%;width:6.83%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:20.47%;left:65.07%;width:6.57%;height:2.36%;font-size:8px;">
<input type="text" class="f" style="top:20.42%;left:71.75%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" class="f" style="top:20.37%;left:79.11%;width:7.19%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:20.37%;left:86.35%;width:9.00%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:22.70%;left:46.15%;width:12.21%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:22.70%;left:58.32%;width:6.83%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:22.79%;left:65.10%;width:6.57%;height:2.36%;font-size:8px;">
<input type="text" class="f" style="top:22.78%;left:71.71%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" class="f" style="top:22.75%;left:79.14%;width:7.19%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:22.75%;left:86.38%;width:9.00%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:22.93%;left:16.76%;width:27.54%;height:1.00%;font-size:8px;">
<input type="text" class="f" style="top:24.12%;left:16.76%;width:27.54%;height:1.00%;font-size:8px;">

{{-- ══ PARCEL 2 ══ --}}
<input type="text" name="parcel_barangay[]" value="{{ old('parcel_barangay.1', $parcel2?->farm_location_barangay ?? '') }}" autocomplete="off"
    class="f" style="top:23.11%;left:16.81%;width:27.50%;height:1.00%;font-size:9px;">
<input type="text" name="parcel_municipality[]" value="{{ old('parcel_municipality.1', $parcel2?->farm_location_municipality ?? '') }}" autocomplete="off"
    class="f" style="top:24.28%;left:16.81%;width:27.50%;height:1.00%;font-size:9px;">
<input type="text" name="parcel_area[]" value="{{ old('parcel_area.1', $parcel2?->total_farm_area_ha ?? '') }}" autocomplete="off"
    class="f" style="top:25.94%;left:23.89%;width:2.31%;height:1.00%;font-size:9px;">
...
<input type="text" name="parcel_owner_name[]" value="{{ old('parcel_owner_name.1', $parcel2?->owner_name ?? '') }}" autocomplete="off"
    class="f" style="top:32.00%;left:26.22%;width:17.99%;height:1.00%;font-size:8px;">
<input type="text" class="f" style="top:33.14%;left:26.04%;width:17.99%;height:1.00%;font-size:8px;">
<input type="text" class="f" style="top:30.84%;left:29.40%;width:14.59%;height:1.00%;font-size:8px;">
<input type="checkbox" class="cb" style="top:32.41%;left:10.36%;">
<input type="checkbox" class="cb" style="top:33.61%;left:10.36%;">
<input type="text" name="parcel_crop[]" value="{{ old('parcel_crop.1', $parcel2?->crop_commodity ?? '') }}" autocomplete="off"
    class="f" style="top:25.17%;left:46.08%;width:12.21%;height:2.43%;font-size:8px;">
<input type="text" name="parcel_size[]" value="{{ old('parcel_size.1', $parcel2?->size_ha ?? '') }}" autocomplete="off"
    class="f" style="top:25.09%;left:58.40%;width:6.57%;height:2.43%;font-size:8px;">
<input type="text" name="parcel_no_head[]" value="{{ old('parcel_no_head.1', $parcel2?->no_of_head ?? '') }}" autocomplete="off"
    class="f" style="top:25.21%;left:65.07%;width:6.57%;height:2.36%;font-size:8px;">
<input type="text" name="parcel_farm_type[]" value="{{ old('parcel_farm_type.1', $parcel2?->farm_type ?? '') }}" autocomplete="off"
    class="f" style="top:25.19%;left:71.79%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" name="parcel_organic[]" value="{{ old('parcel_organic.1', $parcel2?->organic_practitioner ? 'Y' : '') }}" autocomplete="off"
    class="f" style="top:25.10%;left:79.07%;width:7.19%;height:2.43%;font-size:8px;">
<input type="text" name="parcel_remarks[]" value="{{ old('parcel_remarks.1', $parcel2?->remarks ?? '') }}" autocomplete="off"
    class="f" style="top:25.15%;left:86.30%;width:9.00%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:27.43%;left:46.11%;width:12.21%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:27.54%;left:58.43%;width:6.57%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:27.52%;left:65.10%;width:6.57%;height:2.36%;font-size:8px;">
<input type="text" class="f" style="top:27.53%;left:71.71%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" class="f" style="top:27.50%;left:79.06%;width:7.19%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:27.49%;left:86.44%;width:9.00%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:29.89%;left:46.07%;width:12.21%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:29.92%;left:58.46%;width:6.57%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:29.94%;left:65.10%;width:6.57%;height:2.36%;font-size:8px;">
<input type="text" class="f" style="top:29.88%;left:71.73%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" class="f" style="top:29.82%;left:79.10%;width:7.19%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:29.88%;left:86.43%;width:9.00%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:32.18%;left:46.15%;width:12.21%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:32.20%;left:58.43%;width:6.57%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:32.28%;left:65.10%;width:6.57%;height:2.36%;font-size:8px;">
<input type="text" class="f" style="top:32.19%;left:71.76%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" class="f" style="top:32.22%;left:79.08%;width:7.19%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:32.26%;left:86.26%;width:9.00%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:34.60%;left:46.10%;width:12.21%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:34.60%;left:58.49%;width:6.57%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:34.65%;left:65.13%;width:6.57%;height:2.36%;font-size:8px;">
<input type="text" class="f" style="top:34.65%;left:71.73%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" class="f" style="top:34.61%;left:79.08%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" class="f" style="top:34.65%;left:86.36%;width:9.00%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:34.96%;left:17.39%;width:27.41%;height:0.79%;font-size:8px;">
<input type="text" class="f" style="top:36.08%;left:17.39%;width:27.41%;height:0.82%;font-size:8px;">
<input type="text" class="f" style="top:36.98%;left:86.26%;width:9.00%;height:2.43%;font-size:8px;">

{{-- ══ PARCEL 3 ══ --}}
<input type="text" name="parcel_barangay[]" value="{{ old('parcel_barangay.2', $parcel3?->farm_location_barangay ?? '') }}" autocomplete="off"
    class="f" style="top:35.08%;left:16.81%;width:27.50%;height:1.00%;font-size:9px;">
<input type="text" name="parcel_municipality[]" value="{{ old('parcel_municipality.2', $parcel3?->farm_location_municipality ?? '') }}" autocomplete="off"
    class="f" style="top:36.22%;left:16.81%;width:27.50%;height:1.00%;font-size:9px;">
<input type="text" name="parcel_area[]" value="{{ old('parcel_area.2', $parcel3?->total_farm_area_ha ?? '') }}" autocomplete="off"
    class="f" style="top:37.96%;left:24.47%;width:2.44%;height:0.73%;font-size:9px;">
<input type="text" name="parcel_doc_code[]" value="{{ old('parcel_doc_code.2', $parcel3?->ownership_document_code ?? '') }}" autocomplete="off"
    class="f" style="top:40.11%;left:23.26%;width:2.80%;height:0.73%;font-size:9px;">
<input type="checkbox" class="cb" style="top:39.10%;left:30.62%;" {{ $parcel3?->within_ancestral_domain ? 'checked' : '' }}>
<input type="checkbox" class="cb" style="top:39.09%;left:37.65%;" {{ !$parcel3?->within_ancestral_domain ? 'checked' : '' }}>
<input type="checkbox" class="cb" style="top:41.25%;left:30.64%;" {{ $parcel3?->agrarian_reform_beneficiary ? 'checked' : '' }}>
<input type="checkbox" class="cb" style="top:41.25%;left:37.67%;" {{ !$parcel3?->agrarian_reform_beneficiary ? 'checked' : '' }}>
<input type="checkbox" class="cb" style="top:43.07%;left:24.82%;">
<input type="checkbox" class="cb" style="top:43.06%;left:10.90%;">
<input type="text" name="parcel_owner_name[]" value="{{ old('parcel_owner_name.2', $parcel3?->owner_name ?? '') }}" autocomplete="off"
    class="f" style="top:44.02%;left:26.80%;width:17.86%;height:0.73%;font-size:8px;">
<input type="text" class="f" style="top:45.15%;left:26.58%;width:17.99%;height:0.73%;font-size:8px;">
<input type="text" class="f" style="top:42.86%;left:29.98%;width:14.50%;height:0.73%;font-size:8px;">
<input type="checkbox" class="cb" style="top:44.20%;left:10.91%;">
<input type="checkbox" class="cb" style="top:45.38%;left:10.90%;">
<input type="text" name="parcel_crop[]" value="{{ old('parcel_crop.2', $parcel3?->crop_commodity ?? '') }}" autocomplete="off"
    class="f" style="top:37.03%;left:46.07%;width:12.21%;height:2.43%;font-size:8px;">
<input type="text" name="parcel_size[]" value="{{ old('parcel_size.2', $parcel3?->size_ha ?? '') }}" autocomplete="off"
    class="f" style="top:37.04%;left:58.49%;width:6.57%;height:2.43%;font-size:8px;">
<input type="text" name="parcel_no_head[]" value="{{ old('parcel_no_head.2', $parcel3?->no_of_head ?? '') }}" autocomplete="off"
    class="f" style="top:37.00%;left:65.05%;width:6.57%;height:2.36%;font-size:8px;">
<input type="text" name="parcel_farm_type[]" value="{{ old('parcel_farm_type.2', $parcel3?->farm_type ?? '') }}" autocomplete="off"
    class="f" style="top:37.00%;left:71.73%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" name="parcel_organic[]" value="{{ old('parcel_organic.2', $parcel3?->organic_practitioner ? 'Y' : '') }}" autocomplete="off"
    class="f" style="top:37.02%;left:79.11%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" name="parcel_remarks[]" value="{{ old('parcel_remarks.2', $parcel3?->remarks ?? '') }}" autocomplete="off"
    class="f" style="top:36.98%;left:86.26%;width:9.00%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:39.29%;left:46.12%;width:12.21%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:39.40%;left:58.49%;width:6.57%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:39.39%;left:65.10%;width:6.57%;height:2.36%;font-size:8px;">
<input type="text" class="f" style="top:39.42%;left:71.76%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" class="f" style="top:39.36%;left:79.08%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" class="f" style="top:39.27%;left:86.30%;width:9.00%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:41.74%;left:46.15%;width:12.21%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:41.75%;left:58.51%;width:6.57%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:41.70%;left:65.07%;width:6.57%;height:2.36%;font-size:8px;">
<input type="text" class="f" style="top:41.73%;left:71.73%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" class="f" style="top:41.72%;left:79.00%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" class="f" style="top:41.72%;left:86.23%;width:9.00%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:44.04%;left:46.01%;width:12.48%;height:2.37%;font-size:8px;">
<input type="text" class="f" style="top:44.09%;left:58.48%;width:6.57%;height:2.43%;font-size:8px;">
<input type="text" class="f" style="top:44.12%;left:65.04%;width:6.57%;height:2.36%;font-size:8px;">
<input type="text" class="f" style="top:44.11%;left:71.70%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" class="f" style="top:44.06%;left:78.97%;width:7.26%;height:2.40%;font-size:8px;">
<input type="text" class="f" style="top:44.07%;left:86.25%;width:9.00%;height:2.43%;font-size:8px;">

{{-- DECLARATION / SIGNATURE AREA --}}
<input type="text" name="p2_date" value="{{ old('p2_date') }}" autocomplete="off"
    class="f" style="top:62.66%;left:5.29%;width:17.14%;height:1.47%;font-size:9px;">
<input type="text" name="p2_printed_name" value="{{ old('p2_printed_name', isset($farmer) ? strtoupper($farmer->first_name . ' ' . $farmer->middle_name . ' ' . $farmer->surname) : '') }}" autocomplete="off"
    class="f" style="top:62.66%;left:24.28%;width:26.67%;height:1.47%;font-size:9px;">
<input type="text" name="p2_verified_by_1" value="{{ old('p2_verified_by_1') }}" autocomplete="off"
    class="f" style="top:69.40%;left:5.42%;width:26.59%;height:1.47%;font-size:9px;">
<input type="text" name="p2_verified_by_2" value="{{ old('p2_verified_by_2') }}" autocomplete="off"
    class="f" style="top:69.40%;left:34.83%;width:29.82%;height:1.47%;font-size:9px;">
<input type="text" name="p2_verified_by_3" value="{{ old('p2_verified_by_3') }}" autocomplete="off"
    class="f" style="top:69.39%;left:67.37%;width:26.59%;height:1.47%;font-size:9px;">
<input type="text" name="p2_printed_name_barangay" value="{{ old('p2_printed_name_barangay') }}" autocomplete="off"
    class="f" style="top:92.02%;left:5.48%;width:26.59%;height:1.47%;font-size:8px;">
<input type="text" name="p2_printed_name_mao" value="{{ old('p2_printed_name_mao') }}" autocomplete="off"
    class="f" style="top:92.00%;left:34.81%;width:29.82%;height:1.47%;font-size:8px;">
<input type="text" name="p2_printed_name_cafc" value="{{ old('p2_printed_name_cafc') }}" autocomplete="off"
    class="f" style="top:92.00%;left:67.48%;width:26.59%;height:1.47%;font-size:8px;">
