...
<body>
    ...
    <div class="section">
        ...
        <p style="font-size:10px; margin-bottom:5px;"><strong>C. Top Barangays by Number of Registered Farmers</strong>
        </p>
        <table>
            <thead>
                <tr>
        ...
        <table>
            ...
            <tbody>
                ...
                @if($servicesByType->isEmpty())
                    <tr>
                        <td colspan="3" style="text-align:center; color:#999;">No services recorded this period.</td>
                    </tr>
                @endif
            </tbody>
        </table>
    ...
    {{-- II. Narrative Report --}}
    @if($introduction || $accomplishments || $challenges || $recommendations || $conclusion)
        <div class="section">
            <div class="section-title">II. Narrative Report</div>

            @if($introduction)
                <p style="font-size:10px; font-weight:bold; margin-bottom:3px;">A. Introduction</p>
                <p style="font-size:10px; margin-bottom:10px; text-align:justify;">{{ $introduction }}</p>
            @endif

            @if($accomplishments)
                <p style="font-size:10px; font-weight:bold; margin-bottom:3px;">B. Accomplishments</p>
                <p style="font-size:10px; margin-bottom:10px; text-align:justify;">{{ $accomplishments }}</p>
            @endif

            @if($challenges)
                <p style="font-size:10px; font-weight:bold; margin-bottom:3px;">C. Problems / Challenges Encountered</p>
                <p style="font-size:10px; margin-bottom:10px; text-align:justify;">{{ $challenges }}</p>
            @endif

            @if($recommendations)
                <p style="font-size:10px; font-weight:bold; margin-bottom:3px;">D. Recommendations</p>
                <p style="font-size:10px; margin-bottom:10px; text-align:justify;">{{ $recommendations }}</p>
            @endif

            @if($conclusion)
                <p style="font-size:10px; font-weight:bold; margin-bottom:3px;">E. Conclusion</p>
                <p style="font-size:10px; margin-bottom:10px; text-align:justify;">{{ $conclusion }}</p>
            @endif
        </div>
    @endif

    {{-- Remarks placeholder if no narrative --}}
    @if(!$introduction && !$accomplishments && !$challenges && !$recommendations && !$conclusion)
        <div class="section">
            <div class="section-title">II. Remarks and Recommendations</div>
            <div style="border: 1px solid #ddd; padding: 10px; min-height: 60px; border-radius: 4px;">
                <p class="note">[ This section is for manual remarks and recommendations by the Municipal Agriculturist ]
                </p>
                <br><br><br>
            </div>
        </div>
