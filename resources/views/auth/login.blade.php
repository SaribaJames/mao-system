    ...
    <div class="bg-white rounded-lg shadow-md w-full max-w-md p-8">
        ...
        <form method="POST" action="{{ route('login.post') }}">
            ...
            <div class="mb-4">
                ...
                <select name="role_hint" class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary">
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" value="{{ old('email') }}" required
                       placeholder="example@mao.gov.ph"
