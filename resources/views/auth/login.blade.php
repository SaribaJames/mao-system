...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    ...
    <div class="bg-white rounded w-full max-w-md p-8 border border-gray-300">
        ...
        <form method="POST" action="{{ route('login.post') }}">
            ...
            <button type="submit"
                class="w-full bg-primary hover:bg-primary-dark text-white font-semibold py-2 rounded transition duration-200">
                Sign In
            </button>
        </form>
        ...
        <div class="mt-4 border-t border-gray-100 pt-4 text-center">
            ...
            <a href="{{ route('register') }}"
                class="w-full block border border-primary text-primary hover:bg-primary-light font-semibold py-2 rounded transition text-sm text-center">
                Request Access / Sign Up
            </a>
        </div>

        {{-- Demo Access Info --}}
        <div class="mt-4 bg-gray-50 border border-gray-200 rounded p-4 text-xs text-gray-600">
